...
export class GetCommunity extends HTTPEndpoint<string, CommunityInfo> {
    ...
    assertSuccess = (statusCode: number, responseBody: CommunityInfo, communityId: string, validationData: CommunityInfo): void => {
